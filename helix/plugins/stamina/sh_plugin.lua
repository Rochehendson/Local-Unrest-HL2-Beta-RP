...
if (SERVER) then
	...
	function PLUGIN:HUDPaint()
		...
		draw.DrawText("", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		elseif (predictedStamina <= 20) then
		draw.DrawText("⚡", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		elseif (predictedStamina <= 40) then
		draw.DrawText("⚡⚡", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		elseif (predictedStamina <= 60) then
		draw.DrawText("⚡⚡⚡", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		elseif (predictedStamina <= 80) then
		draw.DrawText("⚡⚡⚡⚡", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		elseif (predictedStamina <= 90) then
		draw.DrawText("⚡⚡⚡⚡⚡", "BetaBiggerHud", 405, ScrH() - 50, Color(255, 153, 51, 180))
		end
	end
end
