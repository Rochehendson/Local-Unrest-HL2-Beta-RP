...
do
	...
	function COMMAND:OnCheckAccess(client)
		return client:IsCombine() and (Schema:IsCombineRank(client:Name(), "SCN") or Schema:IsCombineRank(client:Name(), "Dispatcher") or Schema:IsCombineRank(client:Name(), "Leader") or Schema:IsCombineRank(client:Name(), "Officer") or client:Team() == FACTION_OTA)
	end
