...
function ENT:Use(ply)
    ...
    ply:Notify("Текущее количество рационов: " .. ix.RationsStock .. stock)
end
...
function ENT:Draw()
    ...
    local text = "Склад рационов"
    draw.SimpleText(text, "ixMachineInterfaceFontHuge", 16, 6, Color(200, 200, 0, 200))

    draw.SimpleText("Презервация рационов питания", "ixMachineInterfaceFontHuge", 16, 28, Color(200, 200, 200, 200))
