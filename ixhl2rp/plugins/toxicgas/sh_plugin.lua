...
function PLUGIN:IsEquippingGasmask(ply)
    ...
    for x, items in pairs(inventory.slots) do
        for y, item in pairs(items) do
            if item.uniqueID == "body_standart"
            and item:GetData("equip") == true then
                return true
			elseif item.uniqueID == "gasownia"
            and item:GetData("equip") == true then
                return true
			elseif item.uniqueID == "body_sentinel"
            and item:GetData("equip") == true then
                return true
			elseif item.uniqueID == "body_blacktrench"
            and item:GetData("equip") == true then
                return true
			elseif item.uniqueID == "body_shockjock"
            and item:GetData("equip") == true then
                return true
			elseif item.uniqueID == "respirator"
            and item:GetData("equip") == true then
                return true
            end
        end
...
--[[
        ...
        for _, ply in pairs(player.GetAll()) do
            ...
            if ply:Team() == FACTION_VORTIGAUNT then canBreathe = true end
