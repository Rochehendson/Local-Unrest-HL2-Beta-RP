ITEM.name = "Молочная плитка шоколада Альянса"
ITEM.model = "models/bioshockinfinite/hext_candy_chocolate.mdl"
ITEM.category = "Consumables"
ITEM.description = "Плитка чего-то со вкусом шоколада в белой упаковке с синим логотипом Альянса. Это должно быть имитация молочного шоколада. У него странное пластично-жирное послевкусие."
