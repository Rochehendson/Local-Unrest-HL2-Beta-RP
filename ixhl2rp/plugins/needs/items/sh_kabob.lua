ITEM.name = "Мясо хедкраба на шампуре"
ITEM.model = "models/willardnetworks/food/meatskewer.mdl"
ITEM.category = "Consumables"
ITEM.description = "Приготовленное мясо хедкараба,нанизанное на шампур. Продается уличными торговцами или изготавливается Конскриптами и Повстанцами в полевых условиях."
