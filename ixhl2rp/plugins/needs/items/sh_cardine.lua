ITEM.name = "Банка с сардинами"
ITEM.model = "models/bioshockinfinite/cardine_can_open.mdl"
ITEM.category = "Consumables"
ITEM.description = "Банка чего-то, что кажется просто сардинами. Они называют их 'Тухли', потому что Альянс их синтезировал, большая часть наших океанов высохла много лет назад... Они выглядят и на вкус как настоящие сардины, но они должны быть поддельными, верно?"
