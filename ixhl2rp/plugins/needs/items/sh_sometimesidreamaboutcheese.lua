ITEM.name = "Синтезированный Сыр"
ITEM.model = "models/bioshockinfinite/pound_cheese.mdl"
ITEM.category = "Consumables"
ITEM.description = "Сыр очень трудно приготовить без основного ингредиента: молока. Что бы это ни было? Это не сыр, но он наверняка заставит вас мечтать о том, чтобы попробовать настоящий."
