ITEM.name = "Хлебное тесто"
ITEM.model = "models/willardnetworks/food/dough.mdl"
ITEM.category = "Consumables"
ITEM.description = "Сырая буханка из хлебного теста, приготовленная полностью из синтезированных ингредиентов. Выпекать интересно, есть противно."
