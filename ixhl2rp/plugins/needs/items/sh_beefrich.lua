ITEM.name = "Обогащенный говяжий резерв"
ITEM.model = "models/willardnetworks/food/cmb_food4.mdl"
ITEM.category = "Consumables"
ITEM.description = "Коричневая коробка среднего/большого размаера с надписью 'Обогащенный говяжий резерв', пахнет весьма неплохо."
