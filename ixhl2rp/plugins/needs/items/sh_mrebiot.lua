ITEM.name = "ИРП: БИОТИК"
ITEM.model = "models/mres/consumables/lag_mre.mdl"
ITEM.category = "Consumables"
ITEM.description = "Зеленая упаковка ИРП подписанная 'ПИЩЕВЫЕ ДОБАВКИ ДЛЯ БИОТИКА'. Содержит достаточное количество пищевых добавок для экстренных ситуаций, чтобы хватило одному вортигонту на два-три дня при правильном распределении. Обычно встречается в руках рабов-вортигонтов."
