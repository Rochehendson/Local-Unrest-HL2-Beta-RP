ITEM.name = "Белое яйцо"
ITEM.model = "models/willardnetworks/food/egg2.mdl"
ITEM.category = "Consumables"
ITEM.description = "Яйцо, оно разбивается совсем как настоящее, внутри желток и белок, но никто не может сказать, синтезировано оно или нет. Оно белое."
