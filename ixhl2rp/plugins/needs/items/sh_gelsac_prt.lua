ITEM.name = "Приоритетный пакет с желе"
ITEM.model = "models/weapons/w_packatp.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой пакетик с белковым желе. Обычно пресный и безвкусный, но этот пакетик не просто так золотистого цвета. Можно только представить, что содержимое внутри на вкус как чистейший мед."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 50
ITEM.RestoreSatiety =  30
ITEM.returnItems = {}
ITEM.remaining = 5
