ITEM.name = "Поощрительный Набор: Минимальный"
ITEM.model = "models/pg_plops/pg_food/pg_tortellinan.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простая металлическая коробка, содержащая горячую, свежую и несинтезированную пищу.. пусть и безвкусную. Вознаграждение минимального уровня за лояльность Альянсу."
