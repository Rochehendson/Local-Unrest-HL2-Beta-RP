ITEM.name = "Бурбон премиум-класса 'Олд Аппалачи'"
ITEM.model = "models/willardnetworks/food/bourbon.mdl"
ITEM.category = "Consumables"
ITEM.description = "Бутылка элитного бурбона, сделанный пивоваренной компанией 'Олд Аппалачи'. Вы мало где сможете найти это,но если все же встретите: спрячьте, никому не рассказывайте и наслаждайтесь его вкусом. В конечном итоге эта бутылка может оказаться одной из последних на Земле."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 50
