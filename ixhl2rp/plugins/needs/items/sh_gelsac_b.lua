ITEM.name = "Пакет с желе для биотика"
ITEM.model = "models/weapons/w_packatb.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой пакетик, содержащий желейный белок. Пресный, безвкусный и несъедобен для людей. Вортигонты, однако, находят его вполне приемлемым."
