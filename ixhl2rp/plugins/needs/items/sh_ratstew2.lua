ITEM.name = "Консерва: Мясо"
ITEM.model = "models/willardnetworks/food/canned_food1.mdl"
ITEM.category = "Consumables"
ITEM.description = "Открытая консервная банка, содержащая... что-то. Это мясо, но неизвестно, из чего его приготовили. По крайней мере, оно приготовлено?"
