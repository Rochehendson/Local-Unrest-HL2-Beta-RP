ITEM.name = "Бутылка светлого пива"
ITEM.model = "models/bioshockinfinite/hext_bottle_lager.mdl"
ITEM.category = "Consumables"
ITEM.description = "Бутылка пива, наполненная синтетическим алкоголем. Альянс включает это в состав рационов Лоялистов и Столичной Полиции только потому что по вкусу оно отличается от всего остального мусора."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 40
ITEM.RestoreSatiety = 16
ITEM.returnItems = {}
ITEM.remaining = 4
