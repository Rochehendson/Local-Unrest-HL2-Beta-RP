ITEM.name = "Поощрительный Набор: Лоялист"
ITEM.model = "models/pg_plops/pg_food/pg_tortellinap.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простая металлическая коробка с горячими, свежими и ароматными несинтезированными продуктами. Награда Лоялисту за лояльность Альянсу."
