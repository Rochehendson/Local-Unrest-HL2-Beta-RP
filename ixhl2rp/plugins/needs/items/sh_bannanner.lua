ITEM.name = "Банан с маркировкой Альянса"
ITEM.model = "models/bioshockinfinite/hext_banana.mdl"
ITEM.category = "Consumables"
ITEM.description = "Банан или какая-то его разновидность со штампом Альянса на нём. Он не выглядит точно также как оригинал.. но вкус очень похож.."
