ITEM.name = "Клубнично-лимонный пирог"
ITEM.model = "models/willardnetworks/food/cake.mdl"
ITEM.category = "Consumables"
ITEM.description = "Клубнично-лимонный пирог, приготовленный полностью из синтетических материалов. Хотя на вкус он может быть не таким потрясающим, как настоящий, по крайней мере, подача на высоте.."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 21
