ITEM.name = "Овощной Рационный Суп"
ITEM.model = "models/willardnetworks/food/vegetablesoup.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой суп из вареных овощей из продуктовой упаковки. Он почти безвкусный, но определенно полезен для вас!"
