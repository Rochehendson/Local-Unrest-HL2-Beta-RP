...
ITEM.description = "Странные инопланетные ягоды прямиком из мира Зен. Могут быть найдены в зонах, зараженных флорой этого инопланетного мира. Вортигонты обожают их использовать в качестве закуски."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 5
