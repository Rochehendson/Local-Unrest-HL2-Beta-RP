ITEM.name = "Банка газировки - Джонггуо"
ITEM.model = "models/willardnetworks/food/bobdrinks_goodfella.mdl"
ITEM.category = "Consumables"
ITEM.description = "Старый бренд колы, который был распространён по всему Нью-Йорку. Эта банка пережила Семичасовую Войну и Альянс, от чего становится очень ценным продуктом."
