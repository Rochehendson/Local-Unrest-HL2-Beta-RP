ITEM.name = "Коробка с рационами"
ITEM.model = "models/willardnetworks/food/ration_box.mdl"
ITEM.category = "Consumables"
ITEM.description = "Небольшая коробка с пайками, содержащая пять пачек меньшего размера. Любой желающий может купить их за достаточное количество жетонов. Все так же безвкусно, как и всегда."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 0
ITEM.RestoreSatiety =  0
ITEM.returnItems = {smallration, smallration, smallration, smallration, smallration}
ITEM.remaining = 1
