ITEM.name = "Вареная пиявка"
ITEM.model = "models/willardnetworks/food/cooked_leech.mdl"
ITEM.category = "Consumables"
ITEM.description = "Вареная пиявка. Это не самая лучшая еда в округе, но это мясо, и оно чего-то стоит. Просто не думай об этом, когда ешь."
