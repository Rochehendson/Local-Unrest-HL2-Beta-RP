ITEM.name = "Упаковка рациона для лоялистов"
ITEM.model = "models/foodnhouseholdaaaaa/combirationc.mdl"
ITEM.category = "Consumables"
ITEM.description = "Красный упаковка рациона с логотипом Альянса на поверхности и надписью 'ПАКЕТ ДОБАВОК ЛОЯЛЬНОГО КЛАССА'. Содержит достаточное количество пищевых добавок, чтобы хватило одному Лоялисту на два дня, или двум Лоялистам на один день. Согласно названию, обычно находится только в распоряжении лоялистов или даже Столичной Полиции, и содержит продукты лучшего качества."
