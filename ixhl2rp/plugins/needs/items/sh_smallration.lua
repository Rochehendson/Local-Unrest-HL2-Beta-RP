ITEM.name = "Маленькая Упаковка Рациона"
ITEM.model = "models/willardnetworks/food/ration.mdl"
ITEM.category = "Consumables"
ITEM.description = "Относительно однородный блок белка и пищевых добавок. У него практически нет вкуса, но он обеспечивает питание. Некоторые могут приготовить его со специями или ароматизаторами для усиления вкуса!"
