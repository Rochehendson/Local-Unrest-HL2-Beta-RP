ITEM.name = "Стандартный рацион питания"
ITEM.model = "models/foodnhouseholdaaaaa/combirationb.mdl"
ITEM.category = "Consumables"
ITEM.description = "Белый с синими полосами рацион со штампом Альянса на нем и подписанный словами: 'ПАКЕТ ДОБАВОК СТАНДАРТНОГО КАЧЕСТВА'. Содержит достаточно еды для одного гражданина на два дня или для двух граждан на один день."
