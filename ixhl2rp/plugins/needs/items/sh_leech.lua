...
ITEM.description = "Отвратительная, сырая и извивающаяся пиявка. Она съедобна, но сама по себе? Нужно быть очень жестким, чтобы проглотить эту штуку сырой и после этого ее сразу же не вырвало."
