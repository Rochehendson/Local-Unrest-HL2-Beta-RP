ITEM.name = "Поощрительный Набор: Столичная Полиция"
ITEM.model = "models/pg_plops/pg_food/pg_tortellinac.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простая металлическая коробка с горячим, сытным и дополненным питанием для подразделений Столичной Полиции. Включает в себя усилители производительности и прочие стимуляторы."
