ITEM.name = "Рацион-Мясной Суп"
ITEM.model = "models/willardnetworks/food/whitesoup.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой суп на легком бульоне, приготовленный в результате экспериментов с рационами, с мясистой косточкой в центре. Откуда взялось мясо? Наверное, лучше не спрашивать."
