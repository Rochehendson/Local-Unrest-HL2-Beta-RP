...
ITEM.description = "Не совсем круглое яблоко, вероятно, изготовленное с использованием синтезированных растительных веществ. Похоже на что-то из старой видеоигры."
