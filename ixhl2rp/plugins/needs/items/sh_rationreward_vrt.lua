ITEM.name = "Поощрительный Набор: Биотик"
ITEM.model = "models/pg_plops/pg_food/pg_tortellinas.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простая металлическая коробка, содержащая горячую, безвкусную питательную пасту. Вортигонты, похоже, не возражают против этой пищи. Дается рабам-вортигонтам за верность своим обязанностям перед Альянсом."
