ITEM.name = "Синтезированный кусок голубого сыра"
ITEM.model = "models/willardnetworks/food/cheesewheel2c.mdl"
ITEM.category = "Consumables"
ITEM.description = "Кусочек синтезированного голубого сыра. Несмотря на то, что этого продукта, как правило, в изобилии, это не мешает время от времени мечтать о настоящем. От одного взгляда на это становится грустно."
