ITEM.name = "Стейк на шампуре"
ITEM.model = "models/willardnetworks/food/meatskewer2.mdl"
ITEM.category = "Consumables"
ITEM.description = "Приготовленный синтезированный стейк, нанизанный на шампур. Продается уличными торговцами или изготавливается Конскриптами и Повстанцами в полевых условиях."
