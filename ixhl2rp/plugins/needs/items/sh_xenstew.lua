ITEM.name = "Вортигонтский Суп"
ITEM.model = "models/willardnetworks/food/xen_stew.mdl"
ITEM.category = "Consumables"
ITEM.description = "Суп, приготовленный из продуктов мира Зен. Вортигонты любят его! Люди? Гораздо меньше. Это вас не убьет, но, Боже, это отвратительно кисло!"
