ITEM.name = "Приготовленная рыба"
ITEM.model = "models/willardnetworks/food/fishsteak.mdl"
ITEM.category = "Consumables"
ITEM.description = "Конскрипты и Повстанцы обычно добывают только рыбу, да и то редко. Некоторым нерестилищам удалось пережить нападение Альянса, и, когда они были обнаружены, из них можно было выловить рыбу. Это результат работы шеф-повара, а ещё у неё потрясающий вкус!"
