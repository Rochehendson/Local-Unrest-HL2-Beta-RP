ITEM.name = "Поощрительный Набор: Приоритетный"
ITEM.model = "models/pg_plops/pg_food/pg_tortellinat.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простая металлическая коробка с горячей едой премиум-класса только для самых преданных граждан Альянса. Выдается только офицерам Столичной Полиции, Лолялистам или членам Консулата."
