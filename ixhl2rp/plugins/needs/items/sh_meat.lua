ITEM.name = "Кусок мяса"
ITEM.model = "models/willardnetworks/food/meat3.mdl"
ITEM.category = "Consumables"
ITEM.description = "Гражданин в поезде сказал вам, что все, что осталось от дикой природы после того, как Альянс начал собирать урожай с планеты - это бездомные кошки и собаки, и мясо - это то, что от них осталось. Отвратительная мысль, но сейчас отчаянные времена."
