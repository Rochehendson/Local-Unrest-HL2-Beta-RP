ITEM.name = "Пакет белка Гражданской Обороны"
ITEM.model = "models/weapons/w_packatm.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой пакетик с белковым желе. Обычно пресный и безвкусный, но Гражданская Оборона получает усилители работоспособности и другие вещества, которые могут повышать агрессивность при употреблении, а могут и не повышать."
