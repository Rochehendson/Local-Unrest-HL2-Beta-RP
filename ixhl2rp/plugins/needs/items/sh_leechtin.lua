ITEM.name = "Консервированные пиявки"
ITEM.model = "models/willardnetworks/food/cmb_food2.mdl"
ITEM.category = "Consumables"
ITEM.description = "Приготовленная пиявка, она съедобна, но сама по себе? Нужно быть очень жестким, чтобы проглотить эту штуку."
