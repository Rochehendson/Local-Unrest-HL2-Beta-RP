ITEM.name = "Увеличенный рацион"
ITEM.model = "models/willardnetworks/rations/wn_new_ration.mdl"
ITEM.category = "Consumables"
ITEM.description = "Увеличенная версия стандартного пищевого рациона, обычно покупаемого за дополнительные жетоны, с закрывающейся крышкой для хранения."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 70
