ITEM.name = "Стандартный пакет с желе"
ITEM.model = "models/weapons/w_packatc.mdl"
ITEM.category = "Consumables"
ITEM.description = "Простой пакетик с белковым желе. Пресный, безвкусный, но пригодный для употребления в пищу человеком. Приложив дополнительные усилия, можно было бы придать этому продукту немного вкуса."
