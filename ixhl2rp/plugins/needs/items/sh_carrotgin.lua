...
ITEM.description = "Бутылка джина, изготовленная из синтезированного спирта. Некоторые говорят, что 'Уэйн Кинг' тоже сделал это, но Альянс нанес свой логотип на неё. Обычно приберегается для Лоялистов и Столичной Полиции."
