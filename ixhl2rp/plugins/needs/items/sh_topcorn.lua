...
ITEM.description = "Пакет с попкорном, на нем стоит штамп Альянса. Синтезированный, насколько это возможно, но он помог бы вам досмотреть скучный фильм. Если бы такие еще существовали..."
