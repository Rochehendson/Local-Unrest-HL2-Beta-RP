ITEM.name = "Приготовленное инопланетное мясо"
ITEM.model = "models/willardnetworks/food/cooked_alienmeat.mdl"
ITEM.category = "Consumables"
ITEM.description = "Взгляд на это дерьмо вызывает чувства, которые я не могу описать. Это отвратительное мясо инопланетянина. Оно съедобное? Попробуй."
