ITEM.name = "Черный чай собственного приготовления Уэйна Кинга"
ITEM.model = "models/bioshockinfinite/ebsinthebottle.mdl"
ITEM.category = "Consumables"
ITEM.description = "Алкогольный чайный напиток с использованием синтезированного спирта. Уэйн Кинг, похоже, никогда не существовал, но на его бутылках выбит символ Альянс."
