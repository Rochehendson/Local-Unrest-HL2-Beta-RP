ITEM.name = "Приготовленный стейк"
ITEM.model = "models/willardnetworks/food/meat6.mdl"
ITEM.category = "Consumables"
ITEM.description = "Знаешь, я знаю, что такого стейка не существует. Я знаю, что когда я кладу его в рот, Альянс сообщает моему мозгу, что он сочный и вкусный. Спустя девять лет, знаешь, что я осознал? Счастье в неведении."
