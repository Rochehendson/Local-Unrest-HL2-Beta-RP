ITEM.name = "Нарезанный хлеб"
ITEM.model = "models/willardnetworks/food/bread_slice.mdl"
ITEM.category = "Consumables"
ITEM.description = "Нету ничего лучше нарезанного хлеба с тех пор, как появился Альянс. Но он все ещё сделан из переработки отходов, так что, возможно, нет."
