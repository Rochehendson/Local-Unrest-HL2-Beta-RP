ITEM.name = "Коробка хлопьев"
ITEM.model = "models/bioshockinfinite/hext_cereal_box_cornflakes.mdl"
ITEM.category = "Consumables"
ITEM.description = "Черная коробка с надписью 'Заменитель хлопьев с отрубями'. Это очень простая каша, которую можно приготовить на завтрак или в качестве полдника."
