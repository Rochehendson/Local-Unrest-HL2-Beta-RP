ITEM.name = "Рогалик с семечками кунжута"
ITEM.model = "models/willardnetworks/food/bagel1.mdl"
ITEM.category = "Consumables"
ITEM.description = "Рогалик, приготовленный из заменителя муки. По вкусу напоминает что-то, приготовленное из картона, но кунжут смягчает этот вкус."
