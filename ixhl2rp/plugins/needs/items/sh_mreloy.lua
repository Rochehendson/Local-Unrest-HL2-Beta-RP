ITEM.name = "ИРП: ЛОЯЛИСТ"
ITEM.model = "models/mres/consumables/pag_mre.mdl"
ITEM.category = "Consumables"
ITEM.description = "Красная упаковка ИРП с надписью 'ПИЩЕВЫЕ ДОБАВКИ ДЛЯ ЛОЯЛИСТОВ'. Содержит достаточное количество пищевых добавок для экстренных ситуаций, чтобы хватило одному Лоялисту на два-три дня при правильном распределении. Обычно встречается только в руках Лоляистов или Столичной Полиции."
ITEM.useSound = "npc/barnacle/barnacle_crunch2.wav"
ITEM.RestoreSaturation = 64
ITEM.RestoreSatiety =  64
ITEM.returnItems = {}
ITEM.remaining = 8
