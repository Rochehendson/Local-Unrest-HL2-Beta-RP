ITEM.name = "Упаковка с овощами"
ITEM.model = "models/willardnetworks/foods/vege.mdl"
ITEM.category = "Consumables"
ITEM.description = "Коробка с этикеткой 'Разнообразные сушеные овощи', которая включает в себя список многих полезных овощей на выбор!"
