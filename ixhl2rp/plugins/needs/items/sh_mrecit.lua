ITEM.name = "ИРП: ГРАЖДАНИН"
ITEM.model = "models/mres/consumables/tag_mre.mdl"
ITEM.category = "Consumables"
ITEM.description = "Желтая упаковка ИРП с надписью 'ПИЩЕВЫЕ ДОБАВКИ ДЛЯ ГРАЖДАН'. Содержит достаточное количество пищевых добавок для экстренных ситуаций, чтобы хватило одному гражданину на два-три дня при правильном распределении."
