ITEM.name = "Разрезанный синтезированный кусок сыра"
ITEM.model = "models/willardnetworks/food/cheesewheel1c.mdl"
ITEM.category = "Consumables"
ITEM.description = "Нарезанный кусок синтезированного сыра. Несмотря на то, что вокруг, как правило, много всего этого, это не мешает время от времени мечтать о реальном сыре. От одного взгляда на это становится грустно."
