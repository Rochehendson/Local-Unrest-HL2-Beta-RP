ITEM.name = "Камуфляжная униформа" -- Название
ITEM.description = "В этом камуфляже ходили солдаты нацгвардии США в довоенное время, много воды с того времени утекло" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_rebel02.mdl" -- Модель, которая отображается в инвентаре
