ITEM.name = "Синие штаны" -- Название
ITEM.description = "Простые синие брюки, которые достаются всем гражданам, ничего особенного" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/legs_citizen1.mdl" -- Модель, которая отображается в инвентаре
