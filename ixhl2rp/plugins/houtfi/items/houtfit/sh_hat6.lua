ITEM.name = "Панама" -- Название
ITEM.description = "Зеленая панама, идельный выбор для джунглей, но не для пустошей" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_boonie.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "headgear" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
