ITEM.name = "Гражданская куртка с укороченными руками" -- Название
ITEM.description = "Обычная синяя курточка, на ней нет рукавов, в такой ходят опасные люди" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen1.mdl" -- Модель, которая отображается в инвентаре
