ITEM.name = "Синие рабочие штаны" -- Название
ITEM.description = "Синие штаны, в таких ходят рабочие тех огромных заводов с трубами" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/legs_citizen2.mdl" -- Модель, которая отображается в инвентаре
