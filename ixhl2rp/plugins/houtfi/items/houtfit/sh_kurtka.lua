ITEM.name = "Кожаный куртец" -- Название
ITEM.description = "Кожаная куртка черного цвета, выглядит стильно" -- Описание
ITEM.model = "models/willardnetworks/update_items/jacket01_item.mdl" -- Модель, которая отображается в инвентаре
