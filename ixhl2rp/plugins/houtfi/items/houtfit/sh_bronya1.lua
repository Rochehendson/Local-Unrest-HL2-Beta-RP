ITEM.name = "Броня беженца" -- Название
ITEM.description = "Потрепанный временем бронежилет СП и разгрузка, ничего особеного" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_rebel_torso_2.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "kevlar" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
