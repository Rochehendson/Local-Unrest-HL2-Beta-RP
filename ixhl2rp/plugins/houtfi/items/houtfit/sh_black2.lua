ITEM.name = "Черная куртец с закатанными рукавами" -- Название
ITEM.description = "Неплохая черная куртка, такая явно дорого стоит, рукава закатаны" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat5.mdl" -- Модель, которая отображается в инвентаре
