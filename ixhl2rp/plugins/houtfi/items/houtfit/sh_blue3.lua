ITEM.name = "Голубая грязна рубашка с медицинской повязкой" -- Название
ITEM.description = "Голубая рубашка на пуговицах, на плечах завязын белые повязки" -- Описание
