ITEM.name = "Коричневые штаны лоялиста" -- Название
ITEM.description = "Коричневые штаны, часть костюма, что носят лоялисты" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/legs_ca_1.mdl" -- Модель, которая отображается в инвентаре
