ITEM.name = "Лабораторный халат" -- Название
ITEM.description = "Опрятный халат голубого цвета, такие простые люди не носят" -- Описание
ITEM.model = "models/n7/vorti_outfit/doc02.mdl" -- Модель, которая отображается в инвентаре
