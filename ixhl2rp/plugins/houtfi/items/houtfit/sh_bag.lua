ITEM.name = "Сумка" -- Название
ITEM.description = "Сумка на ремне, в которой очень удобно хранить вещи" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/backpack.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "Bag" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
