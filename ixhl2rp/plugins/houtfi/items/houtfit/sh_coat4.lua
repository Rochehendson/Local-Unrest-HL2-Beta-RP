ITEM.name = "Черно-голубая куртка" -- Название
ITEM.description = "Черно-голубая куртка с длинным воротником" -- Описание
ITEM.model = "models/willardnetworks/update_items/redcoat_item.mdl" -- Модель, которая отображается в инвентаре
