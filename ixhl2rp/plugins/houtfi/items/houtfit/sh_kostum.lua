ITEM.name = "Коричневый костюм" -- Название
ITEM.description = "Белая рубашка, черный галстук и коричневый пиджак, в таком ходят только лоялисты" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_loyalist.mdl" -- Модель, которая отображается в инвентаре
