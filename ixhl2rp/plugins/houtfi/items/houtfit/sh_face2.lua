ITEM.name = "Противогаз" -- Название
ITEM.description = "Эта вещь стала лучшим другом обитателей пустошей" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_gasmask.mdl" -- Модель, которая отображается в инвентаре
