ITEM.name = "Рабочая форма" -- Название
ITEM.description = "Бледная униформа стандартных рабочих." -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_refugee_coat.mdl" -- Модель, которая отображается в инвентаре
...
ITEM.bodyGroups = { -- Бодигруппы
	["torso"] = 25,
--	["legs"] = 15 -- Ты можешь добавить то, что одежда меняет несколько бодигрупп, но тогда и категорию лучше поставить на другую.
}
ITEM.height = 1 -- Размеры одежды по высоте и ширине
ITEM.width = 1
