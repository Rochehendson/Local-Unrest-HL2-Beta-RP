ITEM.name = "Куртка ГСР с зеленой пометкой" -- Название
ITEM.description = "Опрятная куртка, которую носят сотрудники ГСР, на правом плече зеленая пометка с буквой 'W'" -- Описание
