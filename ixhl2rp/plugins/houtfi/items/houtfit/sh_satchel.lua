ITEM.name = "Наплечная сумка" -- Название
ITEM.description = "Небольшая черная наплечная сумочка, в ней можно хранить вещи" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/satchel.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "satchel" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
