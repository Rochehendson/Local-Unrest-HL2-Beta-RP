ITEM.name = "Зеленая куртка" -- Название
ITEM.description = "Грязноватая гражданская куртка зеленого цвета, выглядит как будто уже в ней отработали несколько 12-ти часовых смен" -- Описание
