ITEM.name = "Красная клетчатая рубашка" -- Название
ITEM.description = "Красивая клетчатая рубашка красного цвета, такую много кто захотел бы носить" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat6.mdl" -- Модель, которая отображается в инвентаре
