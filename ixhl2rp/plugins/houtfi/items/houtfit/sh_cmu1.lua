ITEM.name = "Куртка ГМС с красной пометкой" -- Название
ITEM.description = "Опрятная куртка, которую носят сотрудники ГМС, на правом плече красная пометка с буквой 'M'" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen_medic.mdl" -- Модель, которая отображается в инвентаре
