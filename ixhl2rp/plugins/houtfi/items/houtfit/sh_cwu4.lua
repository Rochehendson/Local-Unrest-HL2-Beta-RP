ITEM.name = "Куртка ГСР с желтой пометкой" -- Название
ITEM.description = "Опрятная куртка, которую носят сотрудники ГСР, на правом плече желтая пометка с буквой 'D'" -- Описание
