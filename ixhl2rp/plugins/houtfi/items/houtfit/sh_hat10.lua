ITEM.name = "Ушанка" -- Название
ITEM.description = "Ушанка... Как она вообще попала в Америку?!" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_beanie_green.mdl" -- Модель, которая отображается в инвентаре
