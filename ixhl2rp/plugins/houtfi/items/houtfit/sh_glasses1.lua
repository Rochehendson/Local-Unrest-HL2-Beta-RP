ITEM.name = "Очки" -- Название
ITEM.description = "Пара окуляр, которые помогают слабовидящим почувствовать себя нормальным человеком" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/glasses.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "glasses" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
