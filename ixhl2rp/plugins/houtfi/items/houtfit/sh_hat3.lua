ITEM.name = "Черная шапка" -- Название
ITEM.description = "Обычная черная шапка" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_beanie_blue.mdl" -- Модель, которая отображается в инвентаре
