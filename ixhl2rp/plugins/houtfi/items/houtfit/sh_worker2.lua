ITEM.name = "Рабочая форма голубого цвета" -- Название
ITEM.description = "Голубая униформа, которую носят работяги, выглядит грязной" -- Описание
ITEM.model = "models/willardnetworks/update_items/wintercoat_item.mdl" -- Модель, которая отображается в инвентаре
