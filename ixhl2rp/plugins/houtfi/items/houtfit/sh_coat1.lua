ITEM.name = "Серая теплая куртка" -- Название
ITEM.description = "Серая куртка, довольно теплая, неплохой выбор при заморозках" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat1.mdl" -- Модель, которая отображается в инвентаре
