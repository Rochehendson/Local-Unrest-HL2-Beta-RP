ITEM.name = "Теплая куртка с меховым воротником" -- Название
ITEM.description = "Голубая и очень крсивая куртка с меховым воротником, конечно же мех искустенный, но от этого внешний образ не страдает" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat2.mdl" -- Модель, которая отображается в инвентаре
