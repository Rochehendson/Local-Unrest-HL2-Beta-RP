ITEM.name = "Куртка ГСР с оранжевой пометкой" -- Название
ITEM.description = "Опрятная куртка, которую носят сотрудники ГСР, на правом плече оранжевая пометка с буквой 'A'" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen2.mdl" -- Модель, которая отображается в инвентаре
