ITEM.name = "Зеленые усиленные штаны" -- Название
ITEM.description = "Зеленые штаны с защитными элементами, одежда бунтовщиков и беженцев" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/legs_rebel1.mdl" -- Модель, которая отображается в инвентаре
