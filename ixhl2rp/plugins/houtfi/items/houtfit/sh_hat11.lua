ITEM.name = "Коричневый кепарик" -- Название
ITEM.description = "Неплохой головной убор для старпера" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_hat2.mdl" -- Модель, которая отображается в инвентаре
