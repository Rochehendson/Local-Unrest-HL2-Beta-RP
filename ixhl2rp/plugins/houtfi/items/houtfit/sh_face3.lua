ITEM.name = "Красная бандана" -- Название
ITEM.description = "Красная бандана, внешне похожа на платок" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_facewrap.mdl" -- Модель, которая отображается в инвентаре
