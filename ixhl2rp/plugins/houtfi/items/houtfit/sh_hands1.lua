ITEM.name = "Беспалые перчатки" -- Название
ITEM.description = "Беспалые перчатки черного цвета, в них не очень тепло, но выглядят стильно" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/hands_glove_fingerless.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "hands" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
