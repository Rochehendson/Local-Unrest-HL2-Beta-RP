ITEM.name = "Строительная каска" -- Название
ITEM.description = "Каска рабочего белого цвета" -- Описание
ITEM.model = "models/willardnetworks/update_items/workercap_item.mdl" -- Модель, которая отображается в инвентаре
