ITEM.name = "Медицинская маска" -- Название
ITEM.description = "Медицинская маска, которую носят сотрудники ГМС" -- Описание
ITEM.model = "models/willardnetworks/update_items/medicmask_item.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "headstrap" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
