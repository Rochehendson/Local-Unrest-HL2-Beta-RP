ITEM.name = "Серая кепка" -- Название
ITEM.description = "Серая кепка, от нее веет 1861 годом" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/head_confederatehat.mdl" -- Модель, которая отображается в инвентаре
