ITEM.name = "Зеленая камуфляжная куртка" -- Название
ITEM.description = "Грязноватая куртка зеленого цвета, застегивается на пуговицы. на левом предплечьи есть изображение солнца с лучами во все стороны, что бы могло это значить?" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen_refugee.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "Torso" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
ITEM.noResetBodyGroups = true -- Оставляй так

ITEM.bodyGroups = { -- Бодигруппы
	["torso"] = 9
}
ITEM.height = 2 -- Размеры одежды по высоте и ширине
ITEM.width = 2
ITEM.category = "Одежда" -- Оставляй так как есть

ITEM.allowedModels = { -- Оставляй так как есть
