ITEM.name = "Куртка ГСР с синей пометкой" -- Название
ITEM.description = "Опрятная куртка, которую носят сотрудники ГСР, на правом плече синяя пометка с буквой 'L'" -- Описание
