ITEM.name = "Серые штаны" -- Название
ITEM.description = "Серые и немного грязные штаны, все же лучше чем ходить в одних трусах как было в Сити-8" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/legs_citizen3.mdl" -- Модель, которая отображается в инвентаре
ITEM.outfitCategory = "legs" -- Слот одежды, название какое хочешь, это для того, чтобы ты не мог Torso надеть на Torso и бгшки не баговались
