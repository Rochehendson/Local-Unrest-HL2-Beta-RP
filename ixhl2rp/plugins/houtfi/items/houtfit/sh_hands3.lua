ITEM.name = "Латексные перчатки" -- Название
ITEM.description = "Перчатки голубого цвета, что обычно носят сотрудники ГМС" -- Описание
ITEM.model = "models/willardnetworks/clothingitems/hands_glove.mdl" -- Модель, которая отображается в инвентаре
