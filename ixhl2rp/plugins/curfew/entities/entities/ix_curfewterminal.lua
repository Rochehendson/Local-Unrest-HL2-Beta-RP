...
if ( SERVER ) then
  ...
  function ENT:Draw()
    ...
    cam.Start3D2D( pos, ang, 0.1 )
      ...
      draw.SimpleText( "Расписание", "Trebuchet24", w/2, 20, texCol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
      draw.SimpleText( "На текущий момент: " .. self.curSched, "Trebuchet18", w/2, 45, texCol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
      draw.SimpleText( "Время: " .. PLUGIN:GetTimeFormatted(), "Trebuchet18", w/2, 60, texCol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
      draw.SimpleText( "Расписание:", "Trebuchet18", 5, 90, texCol, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
